...
require (
	github.com/DataDog/agent-payload/v5 v5.0.125
	...
	github.com/DataDog/datadog-agent/comp/trace/compression/impl-gzip v0.56.0-rc.6
	github.com/DataDog/datadog-agent/pkg/config/model v0.56.0-rc.6
	github.com/DataDog/datadog-agent/pkg/config/setup v0.56.0-rc.6
...
require (
	...
	go.opentelemetry.io/collector/confmap/converter/expandconverter v0.106.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/envprovider v0.106.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/fileprovider v0.106.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/httpprovider v0.106.0 // indirect
	go.opentelemetry.io/collector/confmap/provider/yamlprovider v0.106.0 // indirect
