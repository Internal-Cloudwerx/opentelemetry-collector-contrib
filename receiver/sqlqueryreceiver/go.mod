...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage v0.106.1
...
require go.opentelemetry.io/collector/consumer/consumertest v0.106.0
